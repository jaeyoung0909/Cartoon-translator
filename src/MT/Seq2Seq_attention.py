...
Original file is located at
    https://colab.research.google.com/drive/1UQ_6pmsG2Gf71_9SbLy7dZ0bIei_OXAK
"""
...
def readfile(lang1, lang2, reverse = False):
  ...
  lines_ko = open(gdrive_data+'/korean-english-park.train.ko', encoding='utf-8').read().strip().split('\n')
  lines_en = open(gdrive_data+'/korean-english-park.train.en', encoding='utf-8').read().strip().split('\n')
